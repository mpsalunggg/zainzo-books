  ...
  return (
    <div className="flex flex-col items-center mt-2 mx-auto">
      <div className="container h-screen overflow-auto mx-auto flex flex-col">
        ...
        <div className="container h-screen max-h-96 items-start self-center drop-shadow-xl bg-white rounded-xl px-6 py-3 overflow-auto flex scrollbar-hide text-[14px]">
            ...
            <table className="w-auto">
              <thead className="">
                <tr className="max-w-lg text-left">
                  ...
                  <th className="font-semibold px-6 py-4 whitespace-nowrap">Photo</th>
                  <th className="font-semibold px-6 py-4 whitespace-nowrap">Name</th>
                  <th className="font-semibold px-6 py-4 whitespace-nowrap">Employee ID</th>
                  <th className="font-semibold px-6 py-4 whitespace-nowrap">Department</th>
                  <th className="font-semibold px-6 py-4 whitespace-nowrap">Job Position</th>
              ...
              <tbody>
                {dataList.map((item) => {
                  return (
                    <tr
                      className="divide-y drop-shadow-md cursor-pointer truncate"
                      onClick={() => {
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_fullname}</td>
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_kode}</td>
                      <td className="whitespace-nowrap px-6 py-3">{!item.department_name ? "-" : item.department_name.department_name}</td>
                      <td className="whitespace-nowrap px-6 py-3">{!item.jobposition_name ? "-" : item.jobposition_name.job_position_name}</td>
                      ...
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_dob}</td>
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_birth_place}</td>
                      ...
                      <td className="whitespace-nowrap px-6 py-3 truncate">{item.employee_relation.employee_residential_addr}</td>
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_phone_number}</td>
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_gender}</td>
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_maritual_status}</td>
                      <td className="whitespace-nowrap px-6 py-3">{item.employee_relation.employee_religion}</td>
                    </tr>
                  );
                })}
              </tbody>
